...
export default function UserProfile(props) {
  return (
    <div className="bg-[#111] border border-[#222] overflow-y-scroll h-[80vh] w-[100vw] lg:h-[60vh] lg:w-[60vw] text-white">
      <div className="h-full w-full flex flex-col items-center lg:flex-row gap-2 lg:justify-center">
        <div className="bg-[#141414] w-full lg:w-1/3 flex justify-center items-start">
