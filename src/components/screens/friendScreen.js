  ...
  return (
    <div className="h-full w-full flex flex-col items-center justify-center pt-2">
      <div className="p-2 px-2 w-full">
        <div className="w-full border border-white"><video className={`${props.initialLayout ? 'aspect-[16/9]': ' aspect-[9/16] xl:aspect-[16/9]'} object-cover h-full w-full`} ref={props.remoteStream} autoPlay></video></div>
      </div>
